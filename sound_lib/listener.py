...
class Listener(object):
    ...
    def get_3d_position(self):
        ...
        bass_call(
            BASS_Get3DPosition, pointer(
                res['position']), pointer(
                res['velocity']), pointer(
                res['front']), pointer(
                    res['top']))
        return res
    ...
    x = property(
        fget=partial(
            _getter, 'position', 'x'), fset=partial(
            _setter, 'position', 'x'))

    y = property(
        fget=partial(
            _getter, 'position', 'y'), fset=partial(
            _setter, 'position', 'y'))

    z = property(
        fget=partial(
            _getter, 'position', 'z'), fset=partial(
            _setter, 'position', 'z'))
    ...
    x_velocity = property(
        fget=partial(
            _getter, 'velocity', 'x'), fset=partial(
            _setter, 'velocity', 'x'))

    y_velocity = property(
        fget=partial(
            _getter, 'velocity', 'y'), fset=partial(
            _setter, 'velocity', 'y'))

    z_velocity = property(
        fget=partial(
            _getter, 'velocity', 'z'), fset=partial(
            _setter, 'velocity', 'z'))
    ...
    front_x = property(
        fget=partial(
            _getter, 'front', 'x'), fset=partial(
            _setter, 'front', 'x'))

    front_y = property(
        fget=partial(
            _getter, 'front', 'y'), fset=partial(
            _setter, 'front', 'y'))

    front_z = property(
        fget=partial(
            _getter, 'front', 'z'), fset=partial(
            _setter, 'front', 'z'))
