...
# HSTREAM BASSMIDIDEF(BASS_MIDI_StreamCreate)(DWORD channels, DWORD flags,
# DWORD freq);
...
# HSTREAM BASSMIDIDEF(BASS_MIDI_StreamCreateFile)(BOOL mem, const void
# *file, QWORD offset, QWORD length, DWORD flags, DWORD freq);
BASS_MIDI_StreamCreateFile = func_type(
    ...
    ctypes.c_ulong)(
        ('BASS_MIDI_StreamCreateFile',
         bassmidi_module))
# HSTREAM BASSMIDIDEF(BASS_MIDI_StreamCreateURL)(const char *url, DWORD
# offset, DWORD flags, DOWNLOADPROC *proc, void *user, DWORD freq);
BASS_MIDI_StreamCreateURL = func_type(
    ...
    ctypes.c_ulong)(
        ('BASS_MIDI_StreamCreateURL',
         bassmidi_module))
# HSTREAM BASSMIDIDEF(BASS_MIDI_StreamCreateFileUser)(DWORD system, DWORD
# flags, const BASS_FILEPROCS *procs, void *user, DWORD freq);
BASS_MIDI_StreamCreateFileUser = func_type(
    ...
    ctypes.c_ulong)(
        ('BASS_MIDI_StreamCreateFileUser',
         bassmidi_module))
# BOOL BASSMIDIDEF(BASS_MIDI_StreamGetMark)(HSTREAM handle, DWORD type,
# DWORD index, BASS_MIDI_MARK *mark);
BASS_MIDI_StreamGetMark = func_type(
    ...
    ctypes.POINTER(BASS_MIDI_MARK))(
        ('BASS_MIDI_StreamGetMark',
         bassmidi_module))
# BOOL BASSMIDIDEF(BASS_MIDI_StreamSetFonts)(HSTREAM handle, const
# BASS_MIDI_FONT *fonts, DWORD count);
...
# DWORD BASSMIDIDEF(BASS_MIDI_StreamGetFonts)(HSTREAM handle,
# BASS_MIDI_FONT *fonts, DWORD count);
...
# BOOL BASSMIDIDEF(BASS_MIDI_StreamEvent)(HSTREAM handle, DWORD chan,
# DWORD event, DWORD param);
...
# DWORD BASSMIDIDEF(BASS_MIDI_StreamGetEvent)(HSTREAM handle, DWORD chan,
# DWORD event);
...
# DWORD BASSMIDIDEF(BASS_MIDI_StreamGetEvents)(HSTREAM handle, DWORD
# track, DWORD filter, BASS_MIDI_EVENT *events);
...
# BOOL BASSMIDIDEF(BASS_MIDI_FontGetInfo)(HSOUNDFONT handle,
...
# const char *BASSMIDIDEF(BASS_MIDI_FontGetPreset)(HSOUNDFONT handle, int
# preset, int bank);
...
# BOOL BASSMIDIDEF(BASS_MIDI_FontLoad)(HSOUNDFONT handle, int preset, int
# bank);
...
# BOOL BASSMIDIDEF(BASS_MIDI_FontPack)(HSOUNDFONT handle, const void
# *outfile, const void *encoder, DWORD flags);
BASS_MIDI_FontPack = func_type(
    ...
    ctypes.c_ulong)(
        ('BASS_MIDI_FontPack',
         bassmidi_module))
# BOOL BASSMIDIDEF(BASS_MIDI_FontUnpack)(HSOUNDFONT handle, const void
# *outfile, DWORD flags);
