...
basswma_module = libloader.load_library(
    'basswma', x86_path=x86_path, x64_path=x64_path)
...
# typedef void (CALLBACK CLIENTCONNECTPROC)(HWMENCODE handle, BOOL
# connect, const char *ip, void *user);
...
# user   : The 'user' parameter value given when calling
# BASS_WMA_EncodeSetNotify

# typedef void (CALLBACK WMENCODEPROC)(HWMENCODE handle, DWORD type, const
...
# HSTREAM BASSWMADEF(BASS_WMA_StreamCreateFile)(BOOL mem, const void
...
BASS_WMA_StreamCreateFileAuth = func_type(
    ...
    ctypes.c_char_p)(
        ('BASS_WMA_StreamCreateFileAuth',
         basswma_module))
# HSTREAM BASSWMADEF(BASS_WMA_StreamCreateFileUser)(DWORD system, DWORD
# flags, const BASS_FILEPROCS *procs, void *user);
...
# const DWORD *BASSWMADEF(BASS_WMA_EncodeGetRates)(DWORD freq, DWORD
# chans, DWORD flags);
...
# HWMENCODE BASSWMADEF(BASS_WMA_EncodeOpen)(DWORD freq, DWORD chans, DWORD
# flags, DWORD bitrate, WMENCODEPROC *proc, void *user);
BASS_WMA_EncodeOpen = func_type(
    ...
    ctypes.c_void_p)(
        ('BASS_WMA_EncodeOpen',
         basswma_module))
# HWMENCODE BASSWMADEF(BASS_WMA_EncodeOpenFile)(DWORD freq, DWORD chans,
# DWORD flags, DWORD bitrate, const char *file);
BASS_WMA_EncodeOpenFile = func_type(
    ...
    ctypes.c_char_p)(
        ('BASS_WMA_EncodeOpenFile',
         basswma_module))
# HWMENCODE BASSWMADEF(BASS_WMA_EncodeOpenNetwork)(DWORD freq, DWORD
# chans, DWORD flags, DWORD bitrate, DWORD port, DWORD clients);
BASS_WMA_EncodeOpenNetwork = func_type(
    ...
    ctypes.c_ulong)(
        ('BASS_WMA_EncodeOpenNetwork',
         basswma_module))
# HWMENCODE BASSWMADEF(BASS_WMA_EncodeOpenNetworkMulti)(DWORD freq, DWORD
# chans, DWORD flags, const DWORD *bitrates, DWORD port, DWORD clients);
...
# BOOL BASSWMADEF(BASS_WMA_EncodeSetNotify)(HWMENCODE handle,
# CLIENTCONNECTPROC *proc, void *user);
...
# BOOL BASSWMADEF(BASS_WMA_EncodeSetTag)(HWMENCODE handle, const char
# *tag, const char *text, DWORD form);
...
# BOOL BASSWMADEF(BASS_WMA_EncodeWrite)(HWMENCODE handle, const void
# *buffer, DWORD length);
