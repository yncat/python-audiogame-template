...
bass_aac_module = libloader.load_library(
...
# HSTREAM BASSAACDEF(BASS_AAC_StreamCreateFile)(BOOL mem, const void
...
# HSTREAM BASSAACDEF(BASS_AAC_StreamCreateURL)(const char *url, DWORD
# offset, DWORD flags, DOWNLOADPROC *proc, void *user);
BASS_AAC_StreamCreateURL = func_type(
    ...
    ctypes.c_void_p)(
        ('BASS_AAC_StreamCreateURL',
         bass_aac_module))
# HSTREAM BASSAACDEF(BASS_AAC_StreamCreateFileUser)(DWORD system, DWORD
...
BASS_AAC_StreamCreateFileUser = func_type(
    ...
    ctypes.c_void_p)(
        ('BASS_AAC_StreamCreateFileUser',
         bass_aac_module))
# HSTREAM BASSAACDEF(BASS_MP4_StreamCreateFile)(BOOL mem, const void
# *file, QWORD offset, QWORD length, DWORD flags);
BASS_MP4_StreamCreateFile = func_type(
    HSTREAM, ctypes.c_byte, ctypes.c_void_p, QWORD, QWORD, ctypes.c_ulong)(
        ('BASS_MP4_StreamCreateFile', bass_aac_module))
# HSTREAM BASSAACDEF(BASS_MP4_StreamCreateFileUser)(DWORD system, DWORD
# flags, const BASS_FILEPROCS *procs, void *user);
